-- ============================================================
-- KCALS Migration 001 – Initial Schema
-- Safe to run on an existing database (fully idempotent).
-- All tables use IF NOT EXISTS; all seed data uses INSERT IGNORE.
-- ============================================================
...
-- ---- Sample recipes (INSERT IGNORE = safe to re-run) ----

INSERT IGNORE INTO `recipes` (`title`, `category`, `calories`, `protein_g`, `carbs_g`, `fat_g`, `prep_minutes`, `ingredients_json`, `instructions`, `is_vegan`, `is_gluten_free`, `satiety_score`, `available_months`) VALUES
...
INSERT IGNORE INTO `health_tips` (`category`, `tip_text`, `icon`) VALUES
